<template>
    <div style="height:100%">
        ...
        >
            <div class="top">
                <el-breadcrumb separator-class="el-icon-arrow-right">
                    ...
                    <el-breadcrumb-item>书签管理</el-breadcrumb-item>
                </el-breadcrumb>
            </div>
                ...
                >
                    <div class="content_top">
                        ...
                        <el-input
                            ...
                            placeholder="请输入"
                        ></el-input>
                        <span style="margin:0 8px 0 40px">书签编号</span>
                        <el-input
                            v-model="selectData.id"
                            placeholder="请输入"
                        ></el-input>
                        <span style="margin:0 8px 0 40px">书签类型</span>
                        <el-select
        ...
        <!-- 新增书签功能 -->
        <BookmarksAdd :addType="addBookData.type" :row="addBookData.row" class="right" v-if="xinzen"></BookmarksAdd>
    </div>
</template>

<script>
import axios from "../../../src/api/requestProduct";
import BookmarksAdd from "./bookmarksAdd.vue";
export default {
    data() {
        return {
            xinzen: false,
    ...
    methods: {
        ...
        deleteRowNext(row){
            console.log(row)
            let url = this.$store.state.productBookURL + "/lc-product/prod/bookmark/info/remove";
            axios.get(url, {
                params : {
                    id : row.number
                }
