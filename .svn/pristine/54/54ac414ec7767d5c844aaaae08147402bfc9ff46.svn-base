    ...
    <el-container class="content_container">
      <el-aside width="400px" class="wxyt_left">
        <div class="left_top">        
          ...
          <el-button type="primary" @click="tableShow=!tableShow">搜索</el-button>
        </div>
      ...
      <el-main class="wxyt_right">
          ...
          <div class="main-bottom">
            <cPast v-if="tableShow"/>
            <div class="templateDiv"  v-if="!tableShow">
              <div class="menuList" v-show="menuShow">
                <ul>
                  <li class="active">自动气象观测站</li>
                  <li>自动土壤水分站</li>
                  <li>逐小时预报</li>
                  <li>设施农业小气候站</li>
                </ul>
              </div>
              <div class="menuBtn" @click="menuShow=!menuShow">
                <div>
                  <icon name="query" scale="3.5"></icon><br>
                  <span>辅助查询</span>
                </div>
              </div>
            </div>
